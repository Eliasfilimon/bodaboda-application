...
import { FiPhone, FiPhoneOff, FiMic, FiMicOff, FiVolume2, FiX } from 'react-icons/fi';
  ...
  return (
    <>
      ...
      <button
        ...
        className={`flex items-center gap-2 bg-green-500 hover:bg-green-600 disabled:bg-sand-300 disabled:cursor-not-allowed text-white rounded-xl transition ${sizeClasses[size]}`}
        title={phoneNumber || t('noPhone')}
      >
        <FiPhone className={iconSizes[size]} />
      ...
      {isCalling && (
        <div className="fixed inset-0 z-100 flex items-center justify-center bg-black/80 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl max-w-sm w-full mx-4 overflow-hidden">
            {/* Caller Info */}
            <div className="bg-navy-900 text-white p-8 text-center">
            ...
            <div className="p-6">
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <button
                  onClick={endCall}
                  className="flex flex-col items-center gap-2 p-4 rounded-xl bg-red-500 hover:bg-red-600 text-white transition"
                >
