...
import { FiShare2, FiCopy, FiSend, FiMessageCircle } from 'react-icons/fi';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-200">
            {/* Header */}
            <div className="bg-amber-500 text-twende-text p-6">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-sand-50 rounded-xl p-4 space-y-2">
                ...
                <div className="flex items-center gap-2 text-navy-800">
                  <HiOutlineMapPin className="text-flame-500" />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-navy-900 hover:bg-navy-800 text-twende-text p-4 rounded-xl transition"
                >
                ...
                >
                  {copied ? <HiOutlineCheck className="w-5 h-5" /> : <FiCopy className="w-5 h-5" />}
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-twende-text p-4 rounded-xl transition"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-twende-text p-4 rounded-xl transition"
                >
