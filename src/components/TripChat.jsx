...
import { FiMessageCircle, FiX, FiSend, FiPhone, FiImage, FiMapPin } from 'react-icons/fi';
        ...
        <div className="bg-white border-t border-sand-200 p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2 bg-amber-500 hover:bg-amber-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-full transition"
            >
