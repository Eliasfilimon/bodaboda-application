import { FiShield, FiCheckCircle, FiStar, FiAward, FiPhone } from 'react-icons/fi';
          ...
          {badges.map((badgeKey) => {
            ...
            return (
              <div key={badgeKey} className="flex items-center gap-2">
                ...
                <FiCheckCircle className="w-4 h-4 text-green-500 ml-auto" />
              </div>
            );
          })}
        </div>
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="relative">
          <div className="w-14 h-14 bg-linear-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center text-white font-bold text-lg">
            {initials}
          </div>
          {rider.isOnline && (
